...
Source0  : https://files.pythonhosted.org/packages/05/5e/5e9a329ba600244f2d37f86131ccec19936d41cba0887240086b44cf4f54/redis-3.5.0.tar.gz
...
%prep
%setup -q -n redis-3.5.0
cd %{_builddir}/redis-3.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588305868
...
cp %{_builddir}/redis-3.5.0/LICENSE %{buildroot}/usr/share/package-licenses/redis/a4b61fde3ceaed3091f9f7ac886713a60beef947
