...
Source0  : https://files.pythonhosted.org/packages/08/ca/549a324a6a40611ac6d6192586ca562e79db86dd25fa59c3877ce69ce910/redis-3.5.2.tar.gz
...
%prep
%setup -q -n redis-3.5.2
cd %{_builddir}/redis-3.5.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589498945
...
cp %{_builddir}/redis-3.5.2/LICENSE %{buildroot}/usr/share/package-licenses/redis/a4b61fde3ceaed3091f9f7ac886713a60beef947
